...
HINT: Remember that an array needs a value in each position, and that value can actually be the returned value of
 a function! So you can just call a function as array values (so don't store the tip values in separate variables 
 first, but right in the new array) 😉

GOOD LUCK 😀
*/
// function displayBill() {
//   var bill = parseInt(document.getElementById('name').value);
...
function calculateTip() {
  var bill = parseInt(document.getElementById('amount').value);
  var tip = bill <= 300 && bill >= 50 ? bill * 0.15 : bill * 0.2;
  var total = bill + tip;
  //console.log(total);
  document.getElementById('Tips').innerText = tip;
